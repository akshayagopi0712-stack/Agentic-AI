...
s=document.getElementByID("status");r
...
def find_first_video_id(query):
    try:
        req=urllib.reqLANuest.Request(
              "http://www.youtube.com/results?search_query="+urllib.parse.quote_plus(query),
              headers={"User_Agent":"Mozilla/5.0","Accept-Language"::"en-US","cookie":"SOCS=CAI"})
...
def build_youtube_target(cmd):
    ...
    return"https://www.youtube.com/result.search_query:"+urllib.parse.quote_plus(q)
